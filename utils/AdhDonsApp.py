...
class AdhDonsAPP(QtWidgets.QMainWindow, adh_cot.Ui_cotisation_adh):
    finished = pyqtSignal(bool)

    def __init__(self, Session, code_adh, edit, adh_dons, parent=None):
        super(AdhDonsAPP, self).__init__(parent)
        try:
    ...
    def init_ihm(self):
        ...
        req_cot = s.query(assogestion_cotisation).filter_by(type="Dons").all()
        if req_cot:
        ...
        try:
            ...
            if req_cot:
                ...
                if self.edit:
                    ...
                    self.dons_edit.setText(str(self.adh_dons.montant_dons))
